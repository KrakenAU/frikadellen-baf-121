...
use crate::bot::client::{
    ...
    is_bazaar_orders_window_title,
    is_order_claimable_from_lore, parse_filled_amount_from_lore,
    parse_bazaar_order_identity, is_buy_bazaar_order_name,
    should_treat_as_bazaar_order_slot, clean_order_item_name, should_cancel_open_order_due_to_age,
